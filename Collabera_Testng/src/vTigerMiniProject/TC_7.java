...
public class TC_7 {
	...
	public void createContact() { 
		...
		String contactFirstName = ExcelLib.readStringData("Sheet1", 4, 0);
		String contactLastName = ExcelLib.readStringData("Sheet1", 4, 1);
		...
		HomePage_7 homePage = new HomePage_7(driver);
